...
function AboutAyurveda() {
  return (
    <div className="flex flex-col bg-[#f3efeb]">
      <div className='flex h-full items-center'>
        <img src={stones} alt="image of stones" className="w-[50%] h-[100vh] object-cover" />
        <div className="flex flex-col w-[50%] text-right mr-[5vw]">
          <h2 className="font-elanor text-6xl text-[#aa1640]">Ayurveda</h2>
          <p className="text-xl">The Science of Life</p>
        </div>
      </div>
      <div className="flex flex-col items-center">
        <div className="h-[100vh] pt-[30vh] bg-[#efdcdc] px-[10vw] ">
        ...
        <div className="flex h-[100vh] items-center px-[10vw]">
         <div className="w-[50%]">
            <h3 className="text-4xl">Agni</h3>
            <h4>The digestive fire</h4>
         </div>
